...
![alt text](Images/0.1%20-%20EC2%20Launch.png)
...
![alt text](Images/0.3%20-%20EC2%20Launch.png)


- I sucessfully connected EC2 instance and got it running in my terminal. as shown in the images below. 

![alt text](Images/0.4%20-%20EC2%20Launch.png) <br>

![alt text](Images/0.5%20-%20EC2%20Launch.png) <br>

![alt text](Images/0.6%20-%20EC2%20Success.png)
...
![alt text](Images/1.1%20-%20installing%20Apache.png)

- Run apache2 package installation `sudo apt install apache2`

![alt text](Images/1.2%20-%20installing%20Apache.png)
...
![alt text](Images/1.5%20-%20Verifying%20Apache.png)
...
![alt text](Images/1.3%20-%20Security%20groups.png)
...
![alt text](Images/1.4%20Connecting%20locally.png)
...
![alt text](Images/1.%205a%20-%20Not%20connecting.jpeg)<br>
![alt text](Images/1.4%20Connecting%20Public%20link%20.jpeg)
...
![alt text](Images/2.0%20-%20Installing%20MYSQL.png)

- When the installation is finished, log in to the MySQL console by typing: `sudo mysql`

![alt text](Images/2.1%20-%20Installing%20MYSQL.png)
...
![alt text](Images/4.0%20%20-%20Everything%20else.png)  
...
![alt text](Images/4.0a%20PHP%20on%20site%20.png)